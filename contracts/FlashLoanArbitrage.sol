...
error FlashLoanArbitrage__NotOwner();
...
contract FlashLoanArbitrage is FlashLoanSimpleReceiverBase {
    ...
    modifier onlyOwner() {
        if (msg.sender != i_owner) { revert FlashLoanArbitrage__NotOwner(); }
        _;
    }

    constructor(address _addressProvider, address _dexContractAddress, address _daiAddress, address _usdcAddress)
